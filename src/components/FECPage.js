...
const FECPage = () => (
  <>
    ...
    <p>This challenge was easily solved with a handy tool in mySQL called like or also known as the (%) wildcard. This allowed my search bar functionality to become quick with responding to the user's inputs and displaying the correct data entries.</p>
    <h4>Got to learn many new concepts along the way such as: </h4>
    <p>Flex box, CSS grid, Styled Components, generating scripts for mock data, responsive layout design, and the importance of file structure.</p>
